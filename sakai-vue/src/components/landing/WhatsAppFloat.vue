    ...
    <transition appear name="zoom-fade">
        <a :href="`https://wa.me/${phone}?text=${encodeURIComponent(prefill)}`" target="_blank" rel="noopener noreferrer" class="wa-float" :style="{ backgroundColor: color }">
            <slot name="icon">
                ...
                <svg id="Layer_1" height="28" width="28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
                    <path
                        style="fill: #ededed"
