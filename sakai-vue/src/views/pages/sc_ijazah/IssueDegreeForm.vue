...
<template>
    ...
    <div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
            ...
            <!-- Submit Button -->
            <div>
                <button type="submit" class="w-full px-4 py-2 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">Submit</button>
            </div>
        </form>
        ...
        <div v-if="transactionHash" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-md">
            <p class="text-sm text-green-700">
                Transaction Hash: <span class="font-mono">{{ transactionHash }}</span>
            </p>
        </div>
