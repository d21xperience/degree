...
<template>
    ...
    <div class="grid grid-cols-1 gap-4">
        <div class=" ">
            <div class="mb-2">
                <Toolbar>
                    <template #start>
                        <Button v-tooltip.bottom="'Upload nilai'" icon="pi pi-upload" severity="info" class="mr-2 text-sm" @click="dialogImport = true" />
                    </template>
                    <template #end>
        ...
        >
            ...
            <template #expansion="slotProps">
                <DataTable :value="slotProps.data.kategorikelas">
                    ...
                    <template v-for="(i, index) in jenjangPendidikan" :key="index">
    ...
    <DialogImport v-model:visible="dialogImport" template-type="transkrip" @save="saveImport" @cancel="cancelImport" />
</template>
