        ...
        <div v-for="tes in BCPlatform[0].accounts" class="flex items-center justify-between bg-blue-50 p-3 rounded-lg mb-4 cursor-pointer">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-500">0x06664...DEc14</div>
                </div>
            </div>
            <div class="text-right">
                <div class="font-semibold">{{ tes.amount }} USD</div>
            ...
            <button type="button" @click="tes">
                <i class="pi pi-ellipsis-v text-gray-500 ml-2 hover:opacity-50"> </i>
            </button>
        </div>
        <!-- <button @click="dialogCreateAccount = true"
            class="w-full flex items-center justify-center py-2 border border-blue-500 text-blue-500 rounded-lg hover:bg-blue-500 hover:text-white">
