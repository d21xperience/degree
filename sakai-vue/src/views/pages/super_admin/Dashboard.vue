<template>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-gray-600 text-lg font-semibold">Total transaksi</h2>
                <span class="text-gray-400 text-sm"> 22 - 29 May 2016 </span>
            </div>
            <div class="text-2xl font-bold text-gray-800 mb-2">128,980</div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-gray-600 text-lg font-semibold">Transaksi per hari</h2>
                <span class="text-gray-400 text-sm"> 22 - 29 May 2016 </span>
            </div>
            <div class="text-2xl font-bold text-gray-800 mb-2">2,905,897</div>
            <div class="flex items-center text-green-500">
                <i class="fas fa-arrow-up"> </i>
                <span class="ml-1"> 33.87% </span>
                <span class="text-gray-400 ml-2"> from last week </span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <img alt="Profile picture of Kevin Anderson" class="w-10 h-10 rounded-full mr-4" height="40" src="https://storage.googleapis.com/a1aa/image/gfBIQO4Djy3nSaTrIM2IyC3fJTAA2B9tKHstIDEYGGpSQz0TA.jpg" width="40" />
                        <div>
                            <div class="text-gray-800 font-semibold">Jhon Doe</div>
                            <div class="text-gray-400 text-sm">on May 22, 2016</div>
                        </div>
                    </div>
