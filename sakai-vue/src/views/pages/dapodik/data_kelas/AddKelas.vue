...
onMounted(async () => {
    if (kelasId) {
        ...
        if (kelas.value) {
            ...
            console.log('rombel', rombel.value);
            // rombel.value = {
...
const isValidate = () => {
    if (!rombel.value.tingkatPendidikanId || rombel.value.nmKelas.trim().length == 0) {
        return false;
    } else {
        return true;
    }
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="flex space-x-1">
                    ...
                    <div class="w-full md:w-40">
                        ...
                        <tingkat-component v-model="rombel.tingkatPendidikanId" :initial-value="rombel.tingkatPendidikanId.toString()" :disabled="isEdit" />
