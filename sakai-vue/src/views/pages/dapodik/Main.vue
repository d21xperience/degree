...
<template>
    <div>
        <!-- <div v-if="!isCompleted || route.name != 'infoSekolah'" class="card">
            <p>Silahkan lengkapi data Kompetensi keahlian Dilayani terlebih dahulu pada menu data sekolah</p>
            <router-link :to="{ name: 'infoSekolah' }">Sekolah</router-link>
        </div> -->
        <div v-if="!isCompleted || route.name !== 'infoSekolah'" class="flex flex-col items-center justify-center p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-sm text-center max-w-md mx-auto">
            <div class="mb-4">
