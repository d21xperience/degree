        ...
        <Toolbar>
            <template #start>
                <div>
                    ...
                    <Button v-tooltip.bottom="'Hapus Semester'" icon="pi pi-trash" severity="danger" class="mr-2 text-sm" :disabled="!selectedSemester || !selectedSemester.length" @click="isDeleteDialog = true" />
                </div>
            </template>
            <template #end>
                ...
                <Button v-tooltip.bottom="'Refresh'" icon="pi pi-refresh" severity="help" class="mr-2 text-sm" @click="initial" />
            </template>
        </Toolbar>
